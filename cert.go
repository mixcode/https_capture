...
var defaultKeyDer []byte	// data embedded from generated/p521privatekey.der

// generated/p521privatekey.der is generated by 'go generate'
...
func genRootCA(key *ecdsa.PrivateKey) (cert *x509.Certificate, err error) {
	...
	var template = &x509.Certificate{
		...
		Subject: pkix.Name{
			...
			CommonName:   "https_capture.github.io",
		},
		//DNSNames: []string{},
